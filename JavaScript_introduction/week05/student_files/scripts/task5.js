...
function output(temple) {
    let templesId = document.querySelector("#temples");

    for (let x = 0; x < templeList.length; x++)
    {
        let temple = templeList[x];
        ...
        h4.textContent = temple.templeLocation;
        // - Creates an HTML <h4> element and add the temple's dedicated property to it
        let h4Dedicated = document.createElement("h4");
        h4Dedicated.textContent = temple.templeDedicated;
...
function sortBy() {
    ...
    templeList.sort((a, b) => (a[sortBy] > b[sortBy] ? 1 : -1));
    output(templeList);
    }
